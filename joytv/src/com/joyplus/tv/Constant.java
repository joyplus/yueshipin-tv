...
//			"letv", "fengxing", "qiyi", "youku", "sinahd", "sohu", "56", "qq","pptv", "m1905" };//来源
	 ...
	 * sohu 合作相关
	 */
	public static final String SO_HU_CP = "so_hu_cp";
	/**
	 * 播放记录
	 */
	public static final String ACTION_SOHU_SAVE_HISTORY = "com.sohutv.tv.action.savePlayInfo";
	/**
	 * 收藏
	 */
	public static final String ACTION_SOHU_COLLECT = "com.sohutv.tv.action.collect";
	/**
	 * 取消收藏
	 */
	public static final String ACTION_SOHU_CANCELCOLLECT = "com.sohutv.tv.action.cancelCollect";
	
	public static final int SOHU_ACTION_TYPE_COLLECT = 0;
	public static final int SOHU_ACTION_TYPE_CANCELCOLLECT = 1;
	public static final int SOHU_ACTION_TYPE_SAVE_HISTORY = 2;
	/*
