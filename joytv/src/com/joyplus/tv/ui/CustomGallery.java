...
//		MarginLayoutParams mlp2 = (MarginLayoutParams) layout.getLayoutParams();
...
//		if(itmeSelectedListener!=null){
//			itmeSelectedListener.onItemSelected(null, layout.getChildAt((selectedIndex+1)), (selectedIndex+1), 0);
//    	}
...
//		if(layout.is`)
		...
		if(rightAnim!=null&&rightAnim.hasStarted()&&!rightAnim.hasEnded()){
			return true;
		}
		switch (keyCode) {
		case KeyEvent.KEYCODE_DPAD_LEFT:
			if(selectedIndex>=0){
				selectedIndex -= 1;
//				mScroller.startScroll(currentLeft, 0, -getChildAt((selectedIndex+1)).getWidth(), 0, 500);
				layout.scrollTo(layout.getChildAt(0).getWidth()*(selectedIndex+1),0);
//				TranslateAnimation anim = new TranslateAnimation(-layout.getChildAt(0).getWidth(),0,0,0);
				if(leftAnim == null){
...
//					leftAnim.ha
		...
		case KeyEvent.KEYCODE_DPAD_RIGHT:
			if(selectedIndex<adapter.getCount()-2){
				...
				layout.scrollTo(layout.getChildAt(0).getWidth()*(selectedIndex+1),0);
				if(rightAnim == null){
					rightAnim = new TranslateAnimation(layout.getChildAt(0).getWidth(),0,0,0);
					rightAnim.setDuration(250);
				}
				layout.startAnimation(rightAnim);
//				TranslateAnimation anim = new TranslateAnimation(layout.getChildAt(0).getWidth(),0,0,0);
//				TranslateAnimation anim = new TranslateAnimation(0,-layout.getChildAt(0).getWidth(),0,0);
//				mScroller.startScroll(currentLeft, 0, getChildAt((selectedIndex+1)).getWidth(), 0, 500);
...
//				});
		...
		case KeyEvent.KEYCODE_ENTER:
			if(itmeClickListener!=null){
        		itmeClickListener.onItemClick(null, layout.getChildAt((selectedIndex+1)), selectedIndex+1, 0);
        	}
			return true;
		default:
...
//				itmeSelectedListener.onItemSelected(null, layout.getChildAt((selectedIndex+1)), (selectedIndex+1), 0);
//        	}
//			mScroller.startScroll(currentLeft, 0, -layout.getChildAt((selectedIndex+1)).getWidth(), 0, 500);
