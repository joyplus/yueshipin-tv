...
import com.joyplus.mediaplayer.JoyplusScreenParams;
...
public class JoyplusMediaPlayerActivity extends Activity implements JoyplusMediaPlayerListener{
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
		...
		Toast.makeText(JoyplusMediaPlayerActivity.this, "Menu Down", Toast.LENGTH_SHORT).show();
		switch(item.getItemId()){
		case R.id.action_FULL:
			mVideoView.setLayoutParams(
					mScreenManager.getParams(JoyplusScreenParams.LINEARLAYOUT_PARAMS_FULL));
			break;
		case R.id.action_4X3:
			mVideoView.setLayoutParams(
					mScreenManager.getParams(JoyplusScreenParams.LINEARLAYOUT_PARAMS_4x3));
			break;
		case R.id.action_16X9:
			mVideoView.setLayoutParams(
					mScreenManager.getParams(JoyplusScreenParams.LINEARLAYOUT_PARAMS_16x9));
			break;
		case R.id.action_OGI:
			mVideoView.setLayoutParams(
					mScreenManager.getParams(JoyplusScreenParams.LINEARLAYOUT_PARAMS_ORIGINAL));
			break;
		}
	...
	private Handler MiniHandler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case JoyplusMediaPlayerMiddleControlMini.MSG_KEYDOWN_PAUSEPLAY:
				...
				break;
			case JoyplusMediaPlayerMiddleControlMini.MSG_REQUESTHIDEVIEW:
				if(mVideoView.getPlayer() != null){
					mVideoView.getPlayer().StartVideo();
				}
				mMiddleControl.JoyplussetVisible(false, JoyplusMediaPlayerMiddleControl.LAYOUT_MINI);
	...
	public boolean onKeyLongPress(int keyCode, KeyEvent event) {
		...
		if(Debug)Log.d("KeyCode","Activity onKeyLongPress() keyCode="+keyCode);
	...
	public boolean onKeyUp(int keyCode, KeyEvent event) {
		...
		if(Debug)Log.d("KeyCode","Activity onKeyUp() keyCode="+keyCode);
		if(JoyplusonKeyDown(keyCode,event))return true;
		if(Debug)Log.d("KeyCode","Activity Activity onKeyUp() keyCode="+keyCode);
		switch(keyCode){
